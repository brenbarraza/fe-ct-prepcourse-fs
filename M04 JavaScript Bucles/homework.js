...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Si num3 es más grande que num1 y num2, aumentar su valor en 1 y retornar 
   //el nuevo valor.
...
function doWhile(num) {
   // Implementar una función que aumente el valor recibido en 5 hasta un límite 
   //de 8 veces.
   ...
   let valor= 0
   let resultado= num 
   do {resultado += 5; valor++} while (valor<8) {return resultado}
}
